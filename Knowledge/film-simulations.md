...
The Film Simulation is the master colour and contrast profile. Every other setting is a modifier layered on top of it, so the base you pick determines the fundamental character of the grade. Fujifilm's own one-line descriptions (from the X-T5 manual, p.122–123) are given first, then the practical grading character.
...
- Character: Modelled on Fujicolor Superia consumer negative film. Punchy but "crunchy": hard tonality, and colour separation that shifts hues, notably cyan-leaning blues and greens with amber reds. Loved for a nostalgic snapshot look. Base for Pacific Blues, Reala Ace, Fujicolor recipes.

### NOSTALGIC Neg.
- Manual: "Amber tinted highlights and rich shadow tone for printed photo look."
- Character: Warm amber highlights over deep, rich shadows. The look of an old printed photo, the 1970s American New Color aesthetic. Base for California Summer, 1976 Kodak, etc.
...
> Both Acros and Monochrome can take a Monochromatic Color tint (warm/cool plus green/magenta); see [color-and-chrome.md](color-and-chrome.md).

## Which base builds which family of looks
