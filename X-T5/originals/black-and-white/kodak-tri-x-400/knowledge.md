...
- Clarity +3: the decisive move: Tri-X's tactile, gritty mid-tone bite. This overrides the Clarity-0 default *because faithfulness demands it* (Tri-X without grit isn't Tri-X).
