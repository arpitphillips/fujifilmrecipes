# Kodak Vision3 500T (5219) — Fujifilm X-T5 (X-Trans V) · CINEMA

Tungsten cinema — the high-speed **night / interior** motion-picture stock. A **clean, accurate** rendering (distinct from the stylised [CineStill 800T](../../../reference-recipes/cinestill-800t/), which is this film with the remjet removed for halation glow). Eterna base. Grounded in Kodak Vision3 500T technical data (tungsten-balanced 3200K, EI 500T/320D, fine grain, wide DR, reduced shadow grain). See [`knowledge.md`](knowledge.md).
...
| White Balance | Incandescent (≈3200K), 0 Red & +1 Blue |
| Dynamic Range | DR400 |
...
| Exposure Compensation | −1/3 to +1/3 (judge per scene) |
