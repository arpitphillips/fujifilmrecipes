...
### Why
- **Astia** — soft gradation keeps the strong warmth flattering on skin (Classic Chrome would mute it; Velvia would scorch it).
- **WB +4R/−5B** — the honeyed golden cast; the engine of the look.
- **DR400 + Highlight −2** — radiant-but-held highlights: backlit rim-light and sun-flare glow instead of clipping.
- **Shadow −1** — softly open shadows, late-sun airiness.
- **CCE Strong + Color +2** — keeps the golds/ambers rich and dimensional rather than washed.
