# Fujicolor Superia X-Tra 400 — Grade Analysis & Understanding
...
|---|---|---|
| **Classic Negative** | — | The base Fujifilm built *from* Superia — cool teal shadows, hue separation, Fuji character. |
| **WB Daylight −1R/+1B** | cool lean | Superia's cool blue highlights / green-magenta cast, kept mild to protect skin. |
| **DR200** | medium | Superia's medium contrast with good gray balance and latitude. |
| **Highlight −1 / Shadow +1** | balanced | Protected cool highlights + slightly deep teal shadows. |
| **Color +2** | medium sat | Superia is medium-saturation, not punchy. |
| **CCE Weak / CCFXB Weak** | modest depth | Gentle richness; CCFXB deepens the signature blues. |
| **Grain Weak/Small, Sharpness 0** | fine + sharp | Datasheet stresses fine grain + high sharpness. |
...
| | This original | [reggies-superia](../../reference-recipes/reggies-superia/) |
|---|---|---|
| Target | **Emulsion as manufactured** (Fuji datasheet: fine grain, excellent sharpness, cool-neutral) | Reggie Ballesteros's **deliberately heavy-handed portrait interpretation** — moody, high-contrast, grain-forward, built to give depth/richness to melanated skin |
| Grain | Weak, Small (faithful to "fine grain, excellent sharpness") | Strong, Large (far grainier/softer than the emulsion spec — deliberate, for vintage mood, not fidelity) |
| Color Chrome FX Blue | Weak (subtle cool depth) | **Strong** (unusually high; pushes rich blue depth rather than following the usual IV→V one-notch-down convention) |
| White Balance | Daylight, −1R/+1B (fixed, repeatable) | Auto, +1R/−4B (adapts per scene, but the overall result still reads stylised, not neutral) |
| Sharpness | 0 (neutral, matches "excellent sharpness") | **−2** (soft) |
