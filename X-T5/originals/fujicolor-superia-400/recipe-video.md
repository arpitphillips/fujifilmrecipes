...
| White Balance | Daylight, −1 Red & +1 Blue | same — cool cast transfers |
| Dynamic Range | DR200 | same value, set **manually** (no AUTO in video) |
| Tone Curve — Highlight | −1 | same |
| Tone Curve — Shadow | +1 | same |
| Color | **+3** | +1 vs stills, to offset lost Color Chrome Effect / FX Blue |
| Sharpness | 0 | same (Superia is sharp) |
| High ISO NR | −4 | same |
