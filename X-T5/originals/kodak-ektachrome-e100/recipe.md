...
- WB Daylight −1R/+1B: E100 is daylight-balanced with a neutral-to-cool rendering (its R/G/B characteristic curves run tightly bundled, with no warm crossover). The cool nudge counteracts Fuji's native warmth.
- H−1 / S−0.5: datasheet: "low contrast tone scale, extended tonal range"; curve shows a gentle shoulder into a high D-max, so soften highlights and keep most shadow density (slides still go deep).
