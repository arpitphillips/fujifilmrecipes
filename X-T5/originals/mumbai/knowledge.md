...
| # | Scene | Condition | What it taught |
|---|---|---|---|
| 1 | Marine Drive at dusk | Golden sea-haze | **THE defining light**: peachy-gold milky sky, skyline dissolving into haze, distant contrast collapse, soft glowing highlights |
| 2 | Gateway of India | Harsh midday sun | Honey-basalt stone + deep clear blue sky + scattered clothing-colour accents; strong texture |
| 3 | CST (Victoria Terminus) | Warm low sun | Golden-ochre Gothic stone *glowing* against pale blue — the colonial-stone warmth |
| 4 | Crawford Market tower | Sun | **Rust + ochre + decay**: corrugated tin rusted over honey sandstone, weeds in the masonry |
| 5 | Ashoka pillar (Kamla Nehru Pk) | Clear sun | Warm sandstone vs saturated blue sky — the warm-stone/blue-sky pairing again |
| 6 | Dhobi Ghat panorama | Hazy sun | **Haze-layered depth**: riotous colourful foreground (laundry mosaic, blue tarps, saffron flag) → smoggy desaturated towers → milky horizon |
| 7 | Dharavi canal | Harsh sun | Earthy chaos (rust/brick/terracotta), blue tarps, deep sky, colour-pop accents, gritty texture |
| 8 | Kaali-peeli taxi interior | Street (HDR source — colour only) | The **yellow/black/red taxi triad**, tiger-print, signage riot |
| 9 | Marine Drive at night | Night | **Warm sodium amber** string lights (Queen's Necklace) + red tail-lights against deep blue-black sea |
...
|---|---|
| Golden-ochre warmth | Classic Negative + Daylight **+3R/−2B** |
| Sea-haze glow, milky horizons | **DR400 + Highlight −1.5** (refined from −1 after the study — every hazy frame demanded softer, held highlights) |
| Up-close contrast, open chaos detail | Shadow +1 |
| Colour accents that pop, not scream | Color +3, CCE Strong |
| Gentle real blues | CCFXB Weak |
| Grit as subject | Grain Strong/Small, Sharpness +1, **Clarity +1** (deliberate non-zero — the texture is the point) |
