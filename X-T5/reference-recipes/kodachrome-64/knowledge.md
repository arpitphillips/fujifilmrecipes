# Kodachrome 64 — Grade Analysis & Understanding
...
|---|---|---|
| **Classic Chrome** base | — | Muted colour + the signature shadow-contrast bump → the calm, editorial foundation. See [film-simulations](../../../Knowledge/film-simulations.md). |
| **White Balance** | Daylight **+2R / −5B** | Warm, sunny cast (add red, remove blue) — the Kodachrome warmth. Fixed Daylight = repeatable. |
| **Dynamic Range** | **DR200** | Slide-film-like contrast with a *mild* highlight lift — keeps punch without clipping. Not DR400: this look wants contrast. |
| **Highlight** | 0 | Neutral, natural highlights. |
| **Shadow** | +0.5 | Slightly deepened blacks → the crisp slide-film shadow. |
| **Color** | +2 | A touch more saturation for rich (not loud) colour. |
| **Color Chrome Effect** | Strong | Depth in reds/yellows/greens so saturated colour stays three-dimensional. |
| **Color Chrome FX Blue** | Off | Already reduced for X-Trans V (see below); keeps blues natural, not over-deep. |
| **Sharpness** | +1 | Crisp outlines — slide film reads as sharp. |
| **Clarity** | +3 | Extra mid-tone micro-contrast → the "bite" and three-dimensionality Kodachrome is known for. |
| **Grain** | Weak, Small | Fine, clean grain — a low-ISO slide stock. |
...
- For a softer, faded alternative in daylight, use Gold 200; for portraits, use a Portra.
