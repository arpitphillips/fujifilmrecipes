# Kodak Tri-X 400 (Black & White) — Grade Analysis & Understanding
...
|---|---|---|
| **Acros** base | +Y / +R / +G (to taste) | The premium B&W profile: rich tonality, superior detail and grain structure. The **coloured filter** choice tunes contrast (see below). |
| **Dynamic Range** | **DR200** | A mild highlight lift while retaining B&W contrast; ISO floor 250. |
| **Highlight** | 0 | Neutral highlights. |
| **Shadow** | **+3** | Deep, rich blacks → the punchy Tri-X shadow weight. |
| **Sharpness** | +1 | Crisp outlines → gritty detail. |
| **Clarity** | **+4** | High mid-tone micro-contrast → the "bite," texture, and three-dimensionality central to the Tri-X look. |
| **Grain** | **Strong, Large** | Heavy, coarse grain → the defining Tri-X texture. |
| **Color Chrome Effect** | Strong | (Set as specified; on monochrome its colour effect is moot, but it's part of the recipe.) |
| **Color Chrome FX Blue** | Off | As above. |
| **White Balance** | Daylight, +9R / −9B | On a B&W base this doesn't change the greys meaningfully; it's a carried-over/toning nuance. |
| **High ISO NR** | −4 | Preserve detail and let grain read as film grain. |
| **ISO** | **1600–12800** | Deliberately *high* → real high-ISO noise blends with the Grain Effect to intensify the analog Tri-X texture. This is the one recipe here that wants high ISO by design. |
