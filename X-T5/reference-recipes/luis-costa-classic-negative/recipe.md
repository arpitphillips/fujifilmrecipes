...
| Grain Effect | Strong, Large | direct |
| Color Chrome Effect | Off | direct |
| Color Chrome FX Blue | **Off** | translated from **Weak** (IV→V one-notch drop; V deepens Classic Neg blues) |
| White Balance | Auto, +4 Red & −4 Blue | direct |
| Dynamic Range | DR200 | direct |
| Highlight | +1 | direct |
| Shadow | 0 | direct |
| Color | +3 | (author offers +1 for a more muted version) |
| Sharpness | 0 | direct |
| High ISO NR | −4 | direct |
| Clarity | 0 | direct |
| ISO | Auto | direct |
