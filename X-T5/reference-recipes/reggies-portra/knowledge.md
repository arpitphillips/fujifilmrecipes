# Reggie's Portra — Grade Analysis & Understanding
...
|---|---|---|
| **Classic Chrome** base | — | Editorial, skin-friendly foundation. |
| **White Balance** | **Auto, +2R / −4B** | *Auto* WB (not fixed) → the cast floats with the light, giving versatility; the +2R/−4B shift keeps a consistent gentle warmth on top of whatever AWB picks. |
| **Dynamic Range** | **DR-Auto** | Camera chooses DR100/200 per scene → adaptive contrast rather than a fixed curve. |
| **Highlight** | −1 | Softened highlights. |
| **Shadow** | −1 | Slightly lifted shadows → gentle, balanced low contrast (milder than Portra 400 v2's −2). |
| **Color** | +2 | Natural, slightly rich colour. |
| **Color Chrome Effect** | Strong | Depth in warm/green tones. |
| **Color Chrome FX Blue** | Off | X-Trans V setting (Reggie confirms he changes *nothing else* for 5th-gen). |
| **Sharpness** | −2 | Soft, flattering outlines. |
| **Clarity** | **0** | *No clarity* → faster save times and maximum versatility; texture comes from grain, not micro-contrast. |
| **Grain** | Weak, Small | Subtle, fine grain — clean and modern. |
