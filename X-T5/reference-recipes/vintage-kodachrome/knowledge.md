...
## The look
First-era (1935–1960) Kodachrome: a painterly slide look with **cyan-shifted blues, darkened reds, and bronze/orange skin**, achieved on Classic Chrome with high highlight contrast (+4), pulled shadows (−2), boosted Color (+4), and deliberate **under**exposure (−1/3 to −1) for density and richness.
